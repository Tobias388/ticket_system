...
?>
    ...
    <body>
        ...
        <main class="main">
            ...
            <form action="../data/register.php" method="POST" class="register_form">
                <div class="form_item">
                ...
                <div class="form_item">
                    ...
                    <label for="repeat_password" class="label">Repetír contraseña</label>
                </div>
                <div class="form_item">
                    <input type="submit" class="input submit" value="Registrarse">
                </div>
                <div class="form_item">
                    <a href="login.php" class="form_a">¿Ya tenés cuenta?</a>
                </div>
            </form>
        </main>
